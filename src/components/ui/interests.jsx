...
// //   const [activeIndex, setActiveIndex] = useState(0);
// //   const [isAutoPlaying, setIsAutoPlaying] = useState(true);
// //   const carouselRef = useRef(); // This ref is declared but not used in the current code
// //   const sectionRefs = {
// //     passions: useRef(),
// //     books: useRef(),
// //     cta: useRef()
...
// //     return () => clearInterval(interval);
// //   }, [isAutoPlaying]); // Added passions.length to dependency array
...
// //       description: "Mastering Spring Boot's DI patterns and applying them in NestJS for cleaner, more testable code",
// //       icon: Rocket,
// //       colorClass: "text-primary", // Using primary color
// //       image: DI
// //     },
// //     {
// //       id: 2,
...
// //   return (
// //     <div className="min-h-screen bg-background text-foreground"> {/* Using bg-background and text-foreground */}
// //       {/* Background effects - optimized with will-change */}
// //       <div className="fixed inset-0 overflow-hidden pointer-events-none">
// //         <div className="absolute top-1/4 left-1/4 w-96 h-96 bg-primary/5 rounded-full blur-3xl will-change-transform"></div> {/* Using primary/5 */}
// //         <div className="absolute bottom-1/4 right-1/4 w-96 h-96 bg-primary/5 rounded-full blur-3xl will-change-transform"></div> {/* Using primary/5 */}
// //       </div>
...
// //               <Link
// //                 to="/"
// //                 className="inline-flex items-center gap-2 text-primary hover:text-primary-light transition-colors duration-200" // Using primary and primary-light
// //               >
// //                 <ArrowLeft className="w-4 h-4" />
// //                 <span className="text-sm">Back to Portfolio</span>
// //               </Link>
...
// //           <motion.h1
// //             className="text-5xl md:text-6xl font-bold text-foreground mb-6" // Using text-foreground
// //             initial={{ opacity: 0, y: 20 }}
// //             animate={{ opacity: 1, y: 0 }}
// //             transition={{ delay: 0.2 }}
// //           >
// //             My <span className="text-primary">Passions</span> & Interests {/* Using text-primary */}
// //           </motion.h1>
// //           <motion.p
// //             className="text-xl text-muted-foreground max-w-3xl mx-auto" // Using text-muted-foreground
// //             initial={{ opacity: 0 }}
// //             animate={{ opacity: 1 }}
// //             transition={{ delay: 0.4 }}
// //           >
...
// //               animate={isPassionsInView ? { opacity: 1, y: 0 } : {}}
// //               transition={{ duration: 0.6 }}
// //               className="text-3xl md:text-4xl font-bold text-foreground mb-4" // Using text-foreground
// //             >
// //               Technical <span className="text-primary">Passions</span> {/* Using text-primary */}
// //             </motion.h2>
// //             <motion.p
// //               initial={{ opacity: 0 }}
// //               animate={isPassionsInView ? { opacity: 1 } : {}}
// //               transition={{ duration: 0.6, delay: 0.2 }}
// //               className="text-muted-foreground max-w-2xl mx-auto" // Using text-muted-foreground
// //             >
// //               Areas I'm deeply invested in and constantly exploring
// //             </motion.p>
// //           </div>
...
// //                   <motion.div
// //                     key={`${passion.id}-${activeIndex}`}
// //                     className={`absolute inset-0 bg-card rounded-2xl overflow-hidden ${index === activeIndex ? 'cursor-default' : 'cursor-pointer'}`} // Using bg-card
// //                     style={{
// //                       scale,
// //                       opacity,
// //                       zIndex,
...
// //                       opacity,
// //                       x: `${xPos}%`,
// //                       boxShadow: index === activeIndex ? '0 25px 50px -12px var(--primary-shadow)' : 'none' // Using CSS variable for shadow
// //                     }}
// //                     exit={{
// //                       scale: 0.9,
// //                       opacity: 0
...
// //                     onClick={() => setActiveIndex(index)}
// //                   >
// //                     <div className="absolute inset-0 bg-gradient-to-t from-card via-card/70 to-transparent" /> {/* Using card color */}
// //                     <div className="absolute bottom-0 left-0 right-0 p-8 text-left">
// //                       <div className="flex items-center gap-3 mb-2">
// //                         <div className={`p-2 rounded-lg ${passion.colorClass} bg-primary/20`}> {/* Using primary/20 */}
// //                           <Icon className="w-5 h-5" />
// //                         </div>
// //                         <h3 className="text-2xl font-bold text-foreground">{passion.title}</h3> {/* Using text-foreground */}
// //                       </div>
// //                       <p className="text-muted-foreground max-w-lg">{passion.description}</p> {/* Using text-muted-foreground */}
// //                     </div>
// //                   </motion.div>
// //                 );
// //               })}
...
// //                 key={index}
// //                 onClick={() => setActiveIndex(index)}
// //                 className={`w-3 h-3 rounded-full transition-all duration-300 ${index === activeIndex ? 'bg-primary w-6' : 'bg-muted'}`} // Using primary and muted
// //                 aria-label={`Go to slide ${index + 1}`}
// //               />
// //             ))}
// //           </motion.div>
...
// //               className="text-3xl md:text-4xl font-bold text-foreground mb-4" // Using text-foreground
// //             >
// //               Books That <span className="text-primary">Fill the Gaps</span> {/* Using text-primary */}
// //             </motion.h2>
// //             <motion.p
// //               initial={{ opacity: 0 }}
// //               animate={isBooksInView ? { opacity: 1 } : {}}
...
// //           <div className="relative">
// //             <div className="absolute inset-y-0 left-0 w-16 bg-gradient-to-r from-background to-transparent z-10 pointer-events-none"></div> {/* Using background color */}
// //             <div className="absolute inset-y-0 right-0 w-16 bg-gradient-to-l from-background to-transparent z-10 pointer-events-none"></div> {/* Using background color */}
...
// //                   key={book.title}
// //                   whileHover={{ y: -5 }}
// //                   className="group relative bg-card/50 backdrop-blur-sm border border-border rounded-xl overflow-hidden hover:border-primary/30 transition-all duration-300" // Using card, border, primary
// //                 >
// //                   <div className="h-56 overflow-hidden">
// //                     <img
// //                       src={book.cover}
...
// //                   </div>
// //                   <div className="p-4">
// //                     <h3 className="font-medium text-foreground text-sm mb-1 group-hover:text-primary transition-colors duration-300 line-clamp-1"> {/* Using foreground and primary */}
// //                       {book.title}
// //                     </h3>
// //                     <p className="text-xs text-muted-foreground mb-2">by {book.author}</p> {/* Using muted-foreground */}
// //                     <Badge
// //                       variant="secondary"
// //                       className="bg-primary/10 text-primary border-primary/20 text-xs" // Using primary variations
// //                     >
// //                       {book.category}
// //                     </Badge>
// //                   </div>
...
// //           animate={isCTAInView ? { opacity: 1, y: 0 } : {}}
// //           transition={{ duration: 0.6 }}
// //           className="text-center p-8 bg-card/30 backdrop-blur-sm border border-border rounded-2xl mb-16" // Using card and border
// //         >
// //           <Coffee className="w-12 h-12 text-primary mx-auto mb-4" /> {/* Using text-primary */}
// //           <h3 className="text-2xl font-bold text-foreground mb-4">Let's Connect Over Shared Interests</h3> {/* Using text-foreground */}
// //           <p className="text-muted-foreground mb-6 max-w-2xl mx-auto"> {/* Using text-muted-foreground */}
// //             Have a book recommendation, want to discuss dependency injection patterns, or just chat about tech? I'd love to hear from you!
// //           </p>
// //           <motion.a
// //             href={`mailto:${portfolioData?.contact?.email}`}
// //             whileHover={{ scale: 1.05 }}
// //             whileTap={{ scale: 0.95 }}
// //             className="inline-flex items-center gap-2 px-6 py-3 bg-primary/10 hover:bg-primary/20 border border-primary/30 hover:border-primary/50 rounded-lg text-primary hover:text-primary-light font-medium transition-all duration-300" // Using primary variations
// //           >
// //             <Coffee className="w-4 h-4" />
// //             Get In Touch
// //             <ExternalLink className="w-4 h-4" />
...
// import React, { useRef, useState, useEffect } from 'react';
// import { motion, useInView, AnimatePresence } from 'framer-motion';
// import { Code2, BookOpen, Coffee, Rocket, Brain, ArrowLeft, ExternalLink, Cloud, FileText, Smartphone, ShoppingBag, Palette } from 'lucide-react'; // Added more icons for diverse interests
// import { Badge } from '@/components/ui/badge';
// import { Link } from 'react-router-dom';
...
//   // Modified passions array to reflect interests from mockPortfolioData
//   // Added more specific descriptions and icons
//   const passions = [
//     {
//       id: 1,
//       title: "Dependency Injection & IoC",
//       description: "Deep diving into IoC containers and DI patterns for building flexible and testable software architectures in Node.js and Java.",
//       icon: Code2, // Changed icon to Code2
//       colorClass: "text-primary",
//       image: DI // Using existing DI image
//     },
//     {
//       id: 2,
//       title: "CQRS & Pub/Sub",
//       description: "Exploring Command Query Responsibility Segregation (CQRS) and Publish/Subscribe patterns for scalable, event-driven microservices.",
//       icon: Rocket, // Changed icon to Rocket
//       colorClass: "text-primary",
//       image: "https://images.unsplash.com/photo-1549490204-7a19e1b2f7d1?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1332&q=80" // New relevant image
//     },
//     {
//       id: 3,
//       title: "Cloud Computing",
//       description: "Hands-on experience with AWS services, serverless architectures (Lambda), and optimizing cloud infrastructure for performance and cost.",
//       icon: Cloud, // New icon for Cloud Computing
//       colorClass: "text-primary",
//       image: "https://images.unsplash.com/photo-1593720219276-0b1e4477c802?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1470&q=80" // Cloud image
//     },
//     {
//       id: 4,
//       title: "Technical Writing",
//       description: "Crafting clear, concise documentation and blog posts to share knowledge and demystify complex technical concepts for wider audiences.",
//       icon: FileText, // New icon for Technical Writing
//       colorClass: "text-primary",
//       image: "https://images.unsplash.com/photo-1544927289-548ec42b6a9c?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1470&q=80" // Writing image
//     },
//     {
//       id: 5,
//       title: "Mobile Development",
//       description: "Exploring cross-platform mobile development with Flutter and Dart, building engaging and performant applications for iOS and Android.",
//       icon: Smartphone, // New icon for Mobile Development
//       colorClass: "text-primary",
//       image: "https://images.unsplash.com/photo-1581456487161-3ef5a5700b21?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1470&q=80" // Mobile image
//     },
//     {
//       id: 6,
//       title: "E-commerce Platforms",
//       description: "Expertise in building, customizing, and maintaining online stores using leading platforms like WordPress/WooCommerce and Shopify.",
//       icon: ShoppingBag, // New icon for E-commerce
//       colorClass: "text-primary",
//       image: "https://images.unsplash.com/photo-1522204523234-87295a0a6531?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1470&q=80" // E-commerce image
//     },
//     {
//       id: 7,
//       title: "Digital Marketing",
//       description: "Applying digital marketing strategies, including SEO optimization and newsletter campaigns, to enhance online presence and drive engagement.",
//       icon: Palette, // New icon for Digital Marketing (representing creativity in campaigns)
//       colorClass: "text-primary",
//       image: "https://images.unsplash.com/photo-1621609764095-b32aac0ff14d?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1470&q=80" // Digital Marketing image
//     }
//   ];
...
//       {/* Background effects - optimized with will-change */}
//       <div className="fixed inset-0 overflow-hidden pointer-events-none">
//         <div className="absolute top-1/4 left-1/4 w-96 h-96 bg-primary/5 rounded-full blur-3xl will-change-transform"></div>
//         <div className="absolute bottom-1/4 right-1/4 w-96 h-96 bg-primary/5 rounded-full blur-3xl will-change-transform"></div>
//       </div>
...
//             transition={{ delay: 0.2 }}
//           >
//             My <span className="text-primary">Passions</span> & Interests
//           </motion.h1>
//           <motion.p
...
//             >
//               Technical <span className="text-primary">Passions</span>
//             </motion.h2>
//             <motion.p
//               initial={{ opacity: 0 }}
//               animate={isPassionsInView ? { opacity: 1 } : {}}
...
//                   <motion.div
//                     key={`${passion.id}-${activeIndex}`}
//                     className={`absolute inset-0 bg-card rounded-2xl overflow-hidden ${index === activeIndex ? 'cursor-default' : 'cursor-pointer'}`}
//                     style={{
//                       scale,
//                       opacity,
//                       zIndex,
...
//                       opacity,
//                       x: `${xPos}%`,
//                       boxShadow: index === activeIndex ? '0 25px 50px -12px var(--primary-shadow)' : 'none'
//                     }}
//                     exit={{
//                       scale: 0.9,
//                       opacity: 0
...
//                     <div className="absolute bottom-0 left-0 right-0 p-8 text-left">
//                       <div className="flex items-center gap-3 mb-2">
//                         <div className={`p-2 rounded-lg ${passion.colorClass} bg-primary/20`}>
//                           <Icon className="w-5 h-5" />
//                         </div>
//                         <h3 className="text-2xl font-bold text-foreground">{passion.title}</h3>
//                       </div>
//                       <p className="text-muted-foreground max-w-lg">{passion.description}</p>
//                     </div>
//                   </motion.div>
//                 );
//               })}
...
//                 key={index}
//                 onClick={() => setActiveIndex(index)}
//                 className={`w-3 h-3 rounded-full transition-all duration-300 ${index === activeIndex ? 'bg-primary w-6' : 'bg-muted'}`}
//                 aria-label={`Go to slide ${index + 1}`}
//               />
//             ))}
//           </motion.div>
...
//               className="text-3xl md:text-4xl font-bold text-foreground mb-4"
//             >
//               Books That <span className="text-primary">Fill the Gaps</span>
//             </motion.h2>
//             <motion.p
//               initial={{ opacity: 0 }}
//               animate={isBooksInView ? { opacity: 1 } : {}}
...
//                   key={book.title}
//                   whileHover={{ y: -5 }}
//                   className="group relative bg-card/50 backdrop-blur-sm border border-border rounded-xl overflow-hidden hover:border-primary/30 transition-all duration-300"
//                 >
//                   <div className="h-56 overflow-hidden">
//                     <img
//                       src={book.cover}
...
//                   </div>
//                   <div className="p-4">
//                     <h3 className="font-medium text-foreground text-sm mb-1 group-hover:text-primary transition-colors duration-300 line-clamp-1">
//                       {book.title}
//                     </h3>
...
//           animate={isCTAInView ? { opacity: 1, y: 0 } : {}}
//           transition={{ duration: 0.6 }}
//           className="text-center p-8 bg-card/30 backdrop-blur-sm border border-border rounded-2xl mb-16"
//         >
//           <Coffee className="w-12 h-12 text-primary mx-auto mb-4" />
//           <h3 className="text-2xl font-bold text-foreground mb-4">Let's Connect Over Shared Interests</h3>
...
//             whileHover={{ scale: 1.05 }}
//             whileTap={{ scale: 0.95 }}
//             className="inline-flex items-center gap-2 px-6 py-3 bg-primary/10 hover:bg-primary/20 border border-primary/30 hover:border-primary/50 rounded-lg text-primary hover:text-primary-light font-medium transition-all duration-300"
//           >
//             <Coffee className="w-4 h-4" />
//             Get In Touch
//             <ExternalLink className="w-4 h-4" />
...
import React, { useRef, useState, useEffect } from 'react';
import { motion, useInView, AnimatePresence } from 'framer-motion';
import { Code2, BookOpen, Coffee, Rocket, Brain, ArrowLeft, ExternalLink, Cloud, FileText, Smartphone, ShoppingBag, Palette } from 'lucide-react';
import { Badge } from '@/components/ui/badge';
import { Link } from 'react-router-dom';

// Import book cover images
import cleanCodeCover from '../../assets/clean code.jpg'; // New cover
import pragmaticProgrammerCover from '../../assets/progmatic.jpg'; // New cover
import refactoringCover from '../../assets/refactoring.jpg'; // New cover
import domainDrivenDesignCover from '../../assets/domain.jpg'; // New cover
import systemDesignCover from '../../assets/system.jpg'; // New cover
import dataintesiveapps from '../../assets/dataintesiveapps.jpg'; // Existing tech cover
import DI from '../../assets/ioc-and-mapper-in-c-1-638.webp'; // Existing tech cover
...
const InterestsPage = ({ portfolioData }) => {
  ...
  const passions = [
    ...
    },
    {
      ...
      icon: Rocket,
      colorClass: "text-primary",
      image: "https://images.unsplash.com/photo-1549490204-7a19e1b2f7d1?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1332&q=80"
    },
    {
      id: 3,
      title: "Cloud Computing",
      ...
      icon: Cloud,
      colorClass: "text-primary",
      image: "https://images.unsplash.com/photo-1593720219276-0b1e4477c802?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1470&q=80"
    },
    {
      id: 4,
      title: "Technical Writing",
      ...
      icon: FileText,
      colorClass: "text-primary",
      image: "https://images.unsplash.com/photo-1544927289-548ec42b6a9c?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1470&q=80"
    },
    {
      id: 5,
      title: "Mobile Development",
      ...
      icon: Smartphone,
      colorClass: "text-primary",
      image: "https://images.unsplash.com/photo-1581456487161-3ef5a5700b21?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1470&q=80"
    },
    {
      id: 6,
      title: "E-commerce Platforms",
      ...
      icon: ShoppingBag,
      colorClass: "text-primary",
      image: "https://images.unsplash.com/photo-1522204523234-87295a0a6531?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1470&q=80"
    },
    {
      id: 7,
      title: "Digital Marketing",
      ...
      icon: Palette,
      colorClass: "text-primary",
      image: "https://images.unsplash.com/photo-1621609764095-b32aac0ff14d?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1470&q=80"
    }
  ];
  ...
  const books = [
    {
      title: "Designing Data-Intensive Applications",
      author: "Martin Kleppmann",
      impact: "Fundamentally changed how I design distributed systems and handle data at scale.",
    ...
    },
    {
      ...
      impact: "Revolutionized my approach to writing maintainable, readable, and efficient code.",
    ...
    },
    {
      ...
      impact: "Provided practical advice on software development, productivity, and personal responsibility.",
    ...
    },
    {
      ...
      impact: "Essential guide to systematically improving code quality without changing external behavior.",
      category: "Code Quality",
      cover: refactoringCover
    },
    {
      title: "Domain-Driven Design: Tackling Complexity in the Heart of Software",
      author: "Eric Evans",
      impact: "Shaped my understanding of complex software architecture through domain modeling.",
      category: "Software Architecture",
      cover: domainDrivenDesignCover
    },
    {
      title: "System Design Interview – An insider's guide",
      author: "Alex Xu",
      impact: "Improved my understanding of designing large-scale systems and preparing for interviews.",
      category: "System Design",
      cover: systemDesignCover
    }
  ];
